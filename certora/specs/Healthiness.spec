...
definition isLiquidate(method f) returns bool = (f.selector == sig:liquidate(Midnight.Obligation, uint256, uint256, uint256, address, address, address, bytes).selector);
